...
**enmendada con acta** el mismo día por la ronda correctiva B1–B8
(`docs/decisiones/enmienda-transversal-b1-b8-2026-08-19.md`: C2, C8, N8,
N14, N16).
Actas: `docs/decisiones/consenso-tabla-claims-2026-08-19.md` y
`docs/decisiones/enmienda-transversal-b1-b8-2026-08-19.md`.
...
| C8 | La cadena de eventos por digest detecta **enlaces rotos respecto de un head confiable** (digest de cabeza conservado fuera del almacén potencialmente reescrito). Un atacante capaz de reescribir todo el almacén puede recalcular la cadena: la detección absoluta de "modificación posterior" no es afirmable (ver N7). | §10.3.5, ADR-007 |
...
| N14 | Ektel no protege su almacén ni su clave contra el proceso supervisado más allá de la separación de escritura por diseño; la protección de rutas y permisos es del despliegue. Si la **clave** se filtra, se anulan **en silencio** C1, C2 y C7: un atacante fabrica capacidades válidas e inicios indistinguibles. Si el **almacén** es reescrito por completo, C8 cae por recálculo de la cadena (los recibos v1 no llevan MAC: no se "fabrican", se reescriben). | ADR-001 A2, ADR-003 A1, ADR-007 |
